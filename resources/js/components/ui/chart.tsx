                            ...
                            {formatter && item?.value !== undefined && item.name ? (
                                ...
                                <>
                                    {itemConfig?.icon ? (
                                        ...
                                        !hideIndicator && (
                                            <div
                                                className={cn('shrink-0 rounded-[2px] border-(--color-border) bg-(--color-bg)', indicator === 'dot' && 'h-2.5 w-2.5 rounded-full', indicator === 'line' && 'w-1', indicator === 'dashed' && 'w-0 border-[1.5px] border-dashed bg-transparent', nestLabel && 'my-0.5')}
                                                style={
                                                    {
