...
3. [x] Health Report Management
    - [x] Upload and manage reports
    - [x] View/download historical data
4. [x] Essence Inventory & Validation
    - [x] Track inventory
...
8. [x] Device & Maintenance
    - [x] Bind/unbind devices per user
...
11. [x] Device Management
    - [x] Tablet linking
    - [x] GPS tracking
12. [x] Notification System
    - [x] Send push to apps - Firebase
